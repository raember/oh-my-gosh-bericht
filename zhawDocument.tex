...
\subsubsection{Go connection hides important information}
...
However: For unknown reasons, \gls{Go} does not allow for getting the underlying \gls{fd} in any way, as it is treated a private field for connections. This had important implications for the project: The listener on the server could not be created with the high-level \gls{API} of \gls{Go} like:
\setlistingGo
