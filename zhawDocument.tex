...
\section{Post-Login Actions}\label{sec:ImplPostLoginActions}
The current implementation either outsources the post-login actions described in \ref{sec:DesignPostLoginActions} to \cite{login}(see \ref{sec:ImplAuthViaPAM}) or omits them completely, as is the case in \ref{sec:ImplAuthViaKeys}. The implementation of this feature is not part of the current project.
