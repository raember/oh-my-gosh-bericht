...
\usepackage{etoolbox}
	...
	\AtEndDocument{\ifdefined\there@is@a@figure\label{fig:was:used:in:doc}\fi%
					\ifdefined\there@is@a@table{tbl:was:used:in:doc}\fi}
	\newcommand{\nelistoffigures}{\@ifundefined{r@fig:was:used:in:doc}{}{\listoffigures\label{sec:ListOfFigures}\newpage}}
	\newcommand{\nelistoftables}{\@ifundefined{r@tbl:was:used:in:doc}{}{\listoftables\label{sec:ListOfTables}\newpage}}
	\makeatother
...
\makeatletter
\newcommand{\printtheindex}{\let\ps@plainorig\ps@plain%
