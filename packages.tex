...
\usepackage{pgfgantt}
\usepackage{xcolor}
	\definecolor{colBg}{RGB}{243,243,243}
	\definecolor{colComment}{RGB}{40,139,27}
	\definecolor{colKeywd}{RGB}{48,31,217}
	\definecolor{colStr}{RGB}{222,143,16}
\usepackage{listings}
...
%		prebreak=\Righttorque
		...
		keywordstyle=\color{colKeywd}\bfseries,
		commentstyle=\color{colComment}\ttfamily,
...
\usepackage{xstring}
	\newcommand{\inlist}[2]{
		\IfSubStr{,#2,}{,\arabic{#1},}{\color{colBg!95!blue}}{\color{colBg}}
	}
...
% Fix old font commands when writing bibliography with bibtex
...
\usepackage{hyphenat} % line breaks within \texttt{}
\usepackage{varioref}
